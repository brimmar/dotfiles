return {
    ...
    config = function ()
        ...
        -- TODO: acho que precisa de gitsigns aqui, não sei se isso é nativo do vim não
        ...
        local components = {
            ...
            lsp = {
                function ()
                    ...
                    -- add formatter
                    -- add linter
                    -- TODO: Ver como pegar os formatters sem ser com null-ls e pra que isso serve pq dependendo eu nem quero
        ...
        if theme_supported and template then
            -- Isso aqui vai mudar o theme dos options que ta dentro do setup, se isso for hardcoded acho que não preciso disso
